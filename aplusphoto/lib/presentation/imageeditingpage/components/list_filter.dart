...
class ListFilter {
  ...
  static ColorFilterGenerator grayHighCon = ColorFilterGenerator(
    name: "GrayCon",
    filters: [
      ColorFilterAddons.brightness(0.08),
      ColorFilterAddons.grayscale(),
  ...
  static ColorFilterGenerator grayCon = ColorFilterGenerator(
    name: "GrayCon",
    filters: [
      ColorFilterAddons.brightness(0.4),
      ColorFilterAddons.grayscale(),
      ColorFilterAddons.contrast(-.2),
    ],
  );
  static ColorFilterGenerator grayHigh = ColorFilterGenerator(
    name: "grayHigh",
    filters: [
...
List<ColorFilterGenerator> listSimpleFilters = [
  ListFilter.none,
  ListFilter.addictiveBlue,
  ListFilter.addictiveRed,
  ListFilter.aden,
  ListFilter.amaro,
  ListFilter.ashby,
  ListFilter.brannan,
  ListFilter.brooklyn,
  ListFilter.charmes,
  ListFilter.clarendon,
  ListFilter.crema,
  ListFilter.dogpatch,
  ListFilter.earlybird,
  ListFilter.f1977,
  ListFilter.gingham,
  ListFilter.ginza,
  ListFilter.hefe,
...
List<ColorFilterGenerator> listBlackWhiteFilters = [
  ListFilter.inkwell,
  ListFilter.lark,
  ListFilter.willow,
  ListFilter.grayHigh,
  ListFilter.moon,
  ListFilter.grayCon,
  ListFilter.grayHighCon,
];

List<Function> listCSSFilter = [
  ...
  CSSFilterPresets.insClarendon,
  CSSFilterPresets.insDogpatch,
  CSSFilterPresets.insEarlybird,
  CSSFilterPresets.insGingham,
  CSSFilterPresets.insHelena,
  CSSFilterPresets.insHudson,
  CSSFilterPresets.insJuno,
  CSSFilterPresets.insKelvin,
  CSSFilterPresets.insLark,
  CSSFilterPresets.insLofi,
  CSSFilterPresets.insPoprocket,
  CSSFilterPresets.insToaster,
